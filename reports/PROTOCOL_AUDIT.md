...
- Explicit cache: all 6 chains were internally clean (first request created cache, positions 2/3 hit). Median three-request-chain normalized input-cost saving versus cold control: 51.4%; median latency saving: 41.0%.
